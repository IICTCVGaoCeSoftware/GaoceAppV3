...
//   //输入，该窗口相机采集的所有有效图像角点 std::vector<cv::Mat>
//   _proCamCorners; //输入，所有打印棋盘格的角点 std::vector<cv::Size>
//   _proPatternSize; //输入，行列方向投影的棋盘格个数 cv::Size _proResolution;
//   //投影仪的分辨率 double _proRealDx; //输入，投影图案的水平偏移 double
//   _proRealDy;                     //输入，投影图案的竖直偏移 double _proCbDx;
//   //输入，棋盘格顶点间的水平距离 double _proCbDy;
//   //输入，棋盘格顶点间的竖直距离
// };
